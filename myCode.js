...
function sumOfMultiples(n, k) {
  ...
  return tempArr.reduce((a, c) => a + c, 0);
}
...
var generate = function (numRows) {
  ...
  for (let i = 0; i < resultArr.length; i++) {
    for (let j = 0; j < resultArr[i].length; j++) {
      ...
      if (typeof resultArr[i][j] === 'undefined') {
...
function isGeometricProgression(sequence) {
  ...
  var r = sequence[l - 1] / sequence[l - 2];
  for (let i = l - 1; i > 0; i--) {
...
/********************************************************************************************************************* */
function htmlEndTagByStartTag(string) {
  var tag = string.split`>`[0].split`<`[1].split` `[0];
  return `</${tag}>`
}
/********************************************************************************************************************* */
/********************************************************************************************************************* */
